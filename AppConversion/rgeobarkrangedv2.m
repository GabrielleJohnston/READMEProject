function [geo_means, freq_out] = rgeobarkrangedv2(freq, signal, min_freq, max_freq)
%RGEOBARKRANGEDV2 Rectangular mean bark scale smoothing and downsampling
    ...
    geo_means(end) = mean(signal((freq_indx(end) - round(band_spacing(end)/2)):(freq_indx(end))));
